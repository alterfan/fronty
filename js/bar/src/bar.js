((mod) => {
    ...
    let addBar = (cm) => {
        ...
        wrap.querySelector(".CodeMirror-simplescroll-vertical").style.maxHeight = "calc(100% - 2rem - 8px)";
        wrap.querySelector(".CodeMirror-simplescroll-vertical").style.top = "2rem";
        wrap.querySelector(".CodeMirror-simplescroll-vertical").style.paddingBottom = "2rem";
        wrap.querySelector(".CodeMirror-scroll").style.maxHeight = "calc(100% - 2rem - 8px)";
