...
options.defaults = {
    ...
    extraKeys: {"Ctrl-Q": "toMatchingTag",'Ctrl-K': function(cm, event) {cm.state.colorpicker.popup_color_picker();}},
    beautify: {
