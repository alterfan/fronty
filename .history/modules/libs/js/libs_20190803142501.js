var cdnjs = "https://cdnjs.cloudflare.com/ajax/";
var libraries = {
    "link": [
...
const libs = new class {
    ...
    removeLib(tag, ID) {
        let alllib = this.usedlib,
            alllibTyped = alllib[tag];
        if (alllibTyped[ID] == undefined) return
...
function printList() {
    var LINK = libs.usedlib["link"];
    var SCRIPT = libs.usedlib["script"];
