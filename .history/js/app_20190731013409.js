...
if (init()) {
    var ui = new UI();
    var htmlEditor = new Editor("frontland-workspace-area-view", 0, "htmlmixed");
    var cssEditor = new Editor("frontland-workspace-area-view", 1, "css");
    var jsEditor = new Editor("frontland-workspace-area-view", 2, "javascript");
