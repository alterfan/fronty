class WorkSpace {
    ...
    changeDirection(editorsArea, newDirection) {
        ...
        $(editorsArea).parents().toggleClass(editorsdir == "vertical" ? "horizontal" : "vertical");
        console.log('editorsdir == "vertical" ? "horizontal" : "vertical": ', editorsdir == "vertical" ? "horizontal" : "vertical");
    }
