...
class Editor {
    ...
    create(parent, index, mode) {
        ...
        js.src = "./lib/codemirror/lib/codemirror.min.js";
        let link = document.createElement("script");
        link.href = "lib/codemirror/lib/codemirror.css";
        workspace.insertBefore(link, workspace.firstChild);
        workspace.appendChild(js);
        this.parent = workspace.querySelector(parent)
        let textarea = document.createElement("textarea"),
            wrapper = document.createElement("div");
            wrapper.className="area-split-vew"
        ...
        this.cm.on("change", function(cm) {
            ...
            setTimeout(initPreview.updatePreview, 300);
        });
