...
$(document).on("click", "[data-direction=\"horizontal\"]", (e) => {
    ...
    sv.changeDirection("vertical");
    sh.changeDirection("vertical" == "horizontal" ? "vertical" : "horizontal");
});
$(document).on("click", "[data-direction=\"vertical\"]", (e) => {
    Workspace.changeDirection("#editorsArea", "vertical");
    sv.changeDirection("horizontal");
    sh.changeDirection("horizontal" == "horizontal" ? "vertical" : "horizontal");
});