...
const setTheme = (theme) => {
    ...
    l.rel = "stylesheet";
    l.theme = theme;
    document.head.childNodes[4]
    console.log('document.head.childNodes[4]: ', document.head.childNodes[4]);
    if (link !== theme) document.head.replaceChild(l, );
    console.log('link !== theme: ', link !== theme);
