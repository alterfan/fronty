const loadView = (panel, side, view) => {
    ...
    $(panel).find('.fronty__workspace__sidebar__content').load(viewUrl);
    console.log(' $(panel).find('.fronty__workspace__sidebar__content').load(viewUrl): ',  $(panel).find('.fronty__workspace__sidebar__content').load(viewUrl));
...
class Sidebar {
    ...
    open(side, view, el) {
        ...
        console.log($(panel).attr("class"), this.getCache(side));
