$(document).ready(function() {
    ...
    workspace.init()
    workspace.editors.cm.setValue(ls.getStorage("project.htmlmixed"));
    workspace.editors.cm.setValue(ls.getStorage("project.css"));
    workspace.editors.cm.setValue(ls.getStorage("project.javascript"));
