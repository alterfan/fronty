var frontland = document.getElementById("frontland");
frontland = frontland.attachShadow({
    mode: 'open'
});
frontland.innerHTML = head;
...
function init() {
    frontland.appendChild(workspaceArea);
    frontland.appendChild(previewArea);
    return true
}