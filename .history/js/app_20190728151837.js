...
var sbRight = new Sidebar("right", ".fronty__workspace");
var sbLeft = new Sidebar("left", ".fronty__workspace");
...
$(document).on("click", "[data-action=\"toggle-sidebar-left\"]", (e) => {
    sbLeft.toggle($(e.target));
});
$(document).on("click", "[data-action=\"toggle-sidebar-right\"]", (e) => {
    sbRight.toggle($(e.target));
});
