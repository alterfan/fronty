...
var sidebar = new class {
    ...
    init() {
        $(".fronty__workspace__sidebar").each(function(index, element) {
            ...
            if (this.splited) {
                ...
                $(element).addClass("visible").find('.fronty__workspace__sidebar__content').load('modules/' + "projects" + '/' + "projects" + '.html ');
            } else {
    ...
    open(el) {
        ...
        setTimeout(function() {
            ...
            $(sidebar).addClass("visible").find('.fronty__workspace__sidebar__content').load();
        }, this.timeout);
        this.view = view;
        this.isClosed = false;
    }
