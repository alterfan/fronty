...
class Pair {
    ...
    init(g) {
        ...
        console.log('this.a.offsetTop: ', this.p.node.offsetTop);
        this.p.id = "#" + pair.p.node.id;
        this.g.offsetPos = this.a.size + this.a.offsetPos + this.p.offsetPos;
        this.offset = this.p.offsetPos + this.a.offsetPos;
    }
    get parentSize() {
...
class Split {
    ...
    move(e) {
        if (!is.Move) return;
        let size = e[pair.clientAxis] + pair.correct - pair.offset,
        ...
        console.log('pair.p.id: ', pair.p.id);
