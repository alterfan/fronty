    ...
    changeDirection(newDirection) {
        ...
        for (var i = 0; i < gutters.length + 1; i++) {
            ...
            if (i < gutters.length) {
                ...
                // g.style["transform"] = "translate" + (newDirection == HORIZONTAL ? "Y" : "X") + "(" + (sum - this.gutterSize / 2) + "px)";
                // g.style["transform"] = "translate" + (newDirection == HORIZONTAL ? "X" : "Y") + "(" + (sum - this.gutterSize / 2) + "px)";
