...
class Split {
    ...
    changeDirection(newDirection) {
        ...
        if (this.direction !== newDirection) {
            const class_name = (newDirection == HORIZONTAL ? VERTICAL : HORIZONTAL) + "-";
            ...
            for (var i = 0; i < gutters.length; i++) {
                ...
                el = document.querySelector("." + class_name + i);
                el.classList.add(newDirection + "-" + i);
                el.classList.remove(class_name);
                if (i + 1 == gutters.length) {
                    console.log('class_name + gutters.length: ', class_name + gutters.length);
                    el = document.querySelector("." + class_name + gutters.length);
                    el.classList.add(newDirection + "-" + gutters.length);
                    el.classList.remove(class_name + gutters.length);
                }
