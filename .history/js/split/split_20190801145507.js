...
class Split {
    ...
    init() {
        ...
        if (this.splitedNodes !== null) {
            ...
            for (var i = 0; i < n; i++) {
                ...
                size = (this.parentSize - (this.gutterSize * (n - 1))) / n;
    ...
    renderGutter(ghostPos) {
        ...
        for (var i = 0; i < quantity; i++) {
            ...
            moveGhost(document.querySelector(".split-gutter-ghost"), this.axis, ghostPos);
    ...
    move(e) {
        ...
        if (!is.Move) return;
        calcA = e[pair.clientAxis] - pair.a.offsetPos - pair.p.offsetPos - (this.gutterSize / 2);
        ...
        moveGhost(document.querySelector(".split-gutter-ghost"), this.axis, calcA);
