...
class Split {
    ...
    renderGutter(ghostPos) {
        ...
        for (var i = 0; i < quantity; i++) {
            ...
            moveGhost(gutterGhost, this.gutterSize, this.axis, ghostPos);
    ...
    move(e) {
        ...
        moveGhost(document.querySelector(".split-gutter-ghost"), this.gutterSize, this.axis, calcA - (this.gutterSize / 2));
