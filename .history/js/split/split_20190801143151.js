...
class Split {
    ...
    renderGutter() {
        ...
        for (var i = 0; i < quantity; i++) {
            ...
            gutterGhost.style["transform"] = translate(this.axis, gutter[this.offsetPos]);
            setTimeout(console.log(this.offsetPos,gutter[this.offsetPos], this.parentNode[this.offsetSize]));
