...
class Split {
    ...
    move(e) {
        ...
        resize(pair.a.node, px2flex(size, this.parentSize, false), pair.sizeAxis);
        console.log(' px2flex(size, this.parentSize, false): ',  px2flex(size, this.parentSize, false));
        resize(pair.b.node, px2flex((pair.a.size - size) + pair.b.size, this.parentSize, false), pair.sizeAxis);
        console.log('px2flex((pair.a.size - size) + pair.b.size, this.parentSize, false): ', px2flex((pair.a.size - size) + pair.b.size, this.parentSize, false));
