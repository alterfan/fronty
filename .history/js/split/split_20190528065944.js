class Split {
    ...
    init() {
        ...
        var elementSize = 100 / this.split_elements_length - parseInt(this.gutterSize);
        ...
        for (let index = 0; index < this.split_elements_length; index++) {
            ...
            console.log('this.split_elements_length - parseInt(this.gutterSize): ', this.split_elements_length - parseInt(this.gutterSize));
        }
        this.gutter();
    }
    gutter() {
    ...
    gutterStyle(gutter, gutterSize) {
        console.log(gutterSize, gutter);
        for (let index = 0; index < gutter.length; index++) {
            switch (this.split_direction) {
                case "vertical":
                    gutter.style.height = gutterSize;
                    gutter.style.width = "100%";

                case "horisontal":
                    gutter.style.width = gutterSize;
                    gutter.style.height = "100%";
            }
        }
