...
class Split {
    ...
    move(e) {
        ...
        if (this.oldSizeB !== pair.b.node[this.offsetSize] && this.oldSizeA === pair.a.node[this.offsetSize]) return;
        console.log(pair.b.node[this.offsetSize], this.oldSizeA, pair.g.node.offsetPos);
