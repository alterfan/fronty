...
class Split {
    ...
    init() {
        ...
        if (this.splitedNodes !== null) {
            ...
            var arr = getLocal("CodeMirror.split." + this.direction) || [];
            for (var i = 0; i < n; i++) {
    ...
    move(e) {
        ...
        let oldSizeA = px2flex(pair.a.node[pair.offsetSize], this.parentSize, false),
            oldSizeB = px2flex(pair.b.node[pair.offsetSize], this.parentSize, false);
        ...
        console.log('oldSize: ' + oldSizeA, 'newSize: ' + newSizeA);
