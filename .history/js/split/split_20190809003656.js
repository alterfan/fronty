...
class Split {
    ...
    changeDirection(newDirection) {
        var old_sizes, gutters, elements;
        ...
        if (this.direction !== newDirection) {
            ...
            elements = document.querySelectorAll(this.direction);
            for (var i = 0; i < gutters.length; i++) {
                ...
                if (i == 0) {
                    elements[i].classList.remove(this.direction + "-" + i);
                    elements[i].classList.add(newDirection + "-" + i);
                }
                elements[n].classList.remove(this.direction + "-" + n);
                elements[n].classList.add(newDirection + "-" + n);
