...
class Pair {
    ...
    init(g) {
        ...
        this.a.node.classList.add(document.querySelector("." + this.g.node.getAttribute("data-direction") + "-" + (this.index - 1)));
        console.log( this.a.node.className);
        this.b.node = this.g.node.nextElementSibling;
        this.b.node.classList.add(document.querySelector("." + this.g.node.getAttribute("data-direction") + "-" + (this.index)));
    ...
    changeDirection(newDirection) {
        ...
        if (this.direction !== newDirection) {
            ...
            for (var i = 0; i < gutters.length + 1; i++) {
                ...
                console.log('class_name + "-" + i: ', class_name + "-" + i);
                if (i < gutters.length) {
                    const g = gutters[i];
                    g.style["height"] = 100 + "%";
                    g.style["width"] = 100 + "%";
