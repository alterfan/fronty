...
class Split {
    ...
    start(e) {
        console.log('!e.target.parentNode.classList.contains("split-gutter-" + this.direction): ', !e.target.parentNode.classList.contains("split-gutter-" + this.direction));
        if (!e.target.parentNode.classList.contains("split-gutter-" + this.direction)) return
        pair.init = e.target.parentNode || e.target;
    ...
    move(e) {
        let newSizeA, newSizeB, calcA, axis;
        console.log('!is.Move: ', !is.Move);
        if (!is.Move) return;
        ...
        axis = this.direction == HORIZONTAL ? "width" : "height"
        resize(pair.a.node, axis, newSizeA);
        console.log(newSizeA, axis);
        resize(pair.b.node, axis, newSizeB);
        console.log(newSizeB, axis);
