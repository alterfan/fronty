...
class Split {
    ...
    renderGutter(pos, index) {
        ...
        gutter.style[this.sizeAxis === "height" ? "width" : "height"] = this.parentNode[this.sizeAxis === "height" ? "offsetWidth" : "offsetHeight"] + "%";
        console.log('this.parentNode.style[this.sizeAxis === "height" ? "width" : "height"]: ', this.parentNode[this.sizeAxis === "height" ? "offsetWidth" : "offsetHeight"]);
        this.parentNode.insertBefore(gutter, this.splitedNodes[index + 1]);
        moveGhost(gutter || gutter.firstChild, this.gutterSize, this.axis, pos);
