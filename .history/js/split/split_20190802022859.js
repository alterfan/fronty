...
class Split {
    ...
    renderGutter(ghostPos, i, sum) {
        ...
        addEventHandler(window, "resize", (e) => {
            console.log(' this.parentNode.style[this.sizeAxis]: ',  this.parentNode.style[this.sizeAxis]);
            moveGutter(gutter, this.gutterSize, this.axis, this.parentNode.style[this.sizeAxis] / 100 * sum);
