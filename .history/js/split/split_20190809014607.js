...
class Split {
    ...
    start(e) {
        ...
        this.parent = "#" + gutter.parentNode.id;
        pair.init(gutter);
    ...
    move(e) {
        ...
        var elements = document.querySelectorAll(this.Options.parent + " > .split-element");
        pair.sizes = getLocal(elements.length + "." + pair.direction, pair.sizes);
