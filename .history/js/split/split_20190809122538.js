...
class Split {
    ...
    renderGutter(index) {
        ...
        this.changeDirection(this.options.direction);
    }
    changeDirection(newDirection) {
        ...
        var sum = 0,
            ...
            old_sizes = getLocal((gutters.length + 1) + ".old." + this.direction) || this.options.sizes,
...
const moveGutter = (ghost, size, axis, pos) => {
    ...
    setTimeout(() => {
        ghost.style['transform'] = translate(axis, pos - (size / 3));
    }, TIMEOUT)
}
