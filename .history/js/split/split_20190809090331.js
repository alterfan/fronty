    ...
    changeDirection(newDirection) {
        ...
        for (var i = 0; i < gutters.length + 1; i++) {
            ...
            if (i < gutters.length) {
                ...
                addEventHandler(window, "resize", (e) => {
                    moveGutter(g, this.gutterSize, (newDirection == HORIZONTAL ? "Y" : "X"), this.parent[newDirection == HORIZONTAL ? "offsetWidth" : "offsetHeight"] / 100 * precents);
                    moveGutter(g, this.gutterSize, (newDirection == HORIZONTAL ? "X" : "Y"), this.parent[newDirection == HORIZONTAL ? "offsetWidth" : "offsetHeight"] / 100 * precents)
                });
                g.setAttribute("data-direction", newDirection);
                g.className = "split-gutter " + newDirection;
                sizeGutter(g, newDirection, this.gutterSize);
                moveGutter(g, this.gutterSize, (newDirection == HORIZONTAL ? "Y" : "X"), sum);
                moveGutter(g, this.gutterSize, (newDirection == HORIZONTAL ? "X" : "Y"), sum);
