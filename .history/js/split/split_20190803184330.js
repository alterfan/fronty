...
class Split {
    ...
    destroy() {
        if (document.getElementById("resizing-overlay")) document.getElementById("resizing-overlay").remove();
            ...
            for (var i = 0; i < document.querySelectorAll(this.elements).length; i++) {
                var el = document.querySelectorAll(this.elements)[i];
                el.classList.remove(this.direction + "-" + i);
                console.log('this.direction + "-" + i: ', this.direction + "-" + i);
            }
            this.parent = "";
            this.elements = "";
            this.direction = "";
