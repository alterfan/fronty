    ...
    changeDirection(newDirection) {
        ...
        if (this.direction !== newDirection) {
            ...
            for (var i = 0; i < gutters.length; i++) {
                ...
                el = document.querySelector("."+newDirection == HORIZONTAL ? VERTICAL : HORIZONTAL + "-" + n);
                el.classList.toggle(newDirection + "-" + n);
                console.log('newDirection==HORIZONTAL?VERTICAL:HORIZONTAL: ', newDirection == HORIZONTAL ? VERTICAL : HORIZONTAL);
                el.classList.toggle(newDirection == HORIZONTAL ? VERTICAL : HORIZONTAL + "-" + n);
