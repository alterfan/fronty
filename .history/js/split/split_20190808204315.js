...
class Split {
    ...
    changeDirection(newDirection) {
        var old_sizes = getLocal(newDirection == "horizontal" ? "vertical" : "horizontal");
        console.log(this.direction, newDirection, old_sizes);
        ...
        console.log('direction, old_sizes: ', newDirection, old_sizes);
