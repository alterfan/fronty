...
class Split extends Options {
    ...
    events() {
        let cQuantity = this.childsQuantity - 1;
        for (let index = 0; index < cQuantity; index++) {
            this.parent.querySelectorAll("gutter");
            console.log('this.parent.querySelectorAll("gutter"): ', this.parent.querySelectorAll("gutter"));
        }
    }
    get child() {
