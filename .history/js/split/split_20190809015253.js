...
class Split {
    ...
    elements(parent) {
        document.querySelectorAll(parent + " > .split-element");
    }
    ...
    start(e) {
        ...
        this.Options.parent = "#" + pair.p.node.id;
        this.elements = document.querySelectorAll(this.Options.parent + " > .split-element");
    ...
    move(e) {
        ...
        //     this.Options.parent = "#" + pair.p.node.id;
        //  this.elements = document.querySelectorAll(this.Options.parent + " > .split-element");
        pair.sizes = getLocal(this.elements(this.Options.parent).length + "." + pair.direction, pair.sizes);
        console.log(this.elements(this.Options.parent).length, pair.sizes);
