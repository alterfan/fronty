...
class Split {
    ...
    set elements(elements) {
        ...
        this.Elements = document.querySelectorAll(this.options.parent > this.options.elements);
        console.log(this.Elements, this.options.parent > elements);
    }
    get elements() {
    ...
    start(e) {
        ...
        console.log(' "#" + gutter.parentNode.id: ', "#" + gutter.parentNode.id);
        pair.init(gutter);
