...
class Split {
    ...
    renderGutter() {
        ...
        for (var i = 0; i < quantity; i++) {
            ...
            gutter.style["transform"] = translate(this.axis, this.splitedNodes[i][this.offsetSize]);
            console.log('this.splitedNodes[i][this.offsetSize]: ', this.splitedNodes[i][this.offsetSize]);
