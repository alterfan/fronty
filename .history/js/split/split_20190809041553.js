...
class Split {
    ...
    changeDirection(newDirection) {
        ...
        if (this.direction !== newDirection) {
            ...
            sum = 0;
            var class_name_old = (newDirection == HORIZONTAL ? VERTICAL : HORIZONTAL);
            ...
            for (var i = 0; i < gutters.length; i++) {
                const g = gutters[i];
                console.log('gutters.length + 1: ', gutters.length);
                sum = sum + this.parent[class_name == HORIZONTAL ? "offsetHeight" : "offsetWidth"] / 100 * old_sizes[i];
                console.log('sum: ', sum);
                g.style[this.Options.direction === HORIZONTAL ? "height" : "width"] = this.gutterSize + "px";
                console.log('this.Options.direction: ', this.Options.direction);
                g.style[this.Options.direction === HORIZONTAL ? "width" : "height"] = 100 + "%";
                g.style["transform"] = "translate" + (class_name == HORIZONTAL ? "Y" : "X") + "(" + 0 + "px)";
