...
class Split {
    ...
    init() {
        ...
        if (this.splitedNodes !== null) {
            ...
            this.renderGutter();
            document.querySelector(".split-gutter-ghost").style["transform"] = translate(this.axis, size);
...
const moveGhost = (ghost,pos) => {
    ...
    setTimeout(() => {
        element.style['flex-basis'] =translate(this.axis, pos);
    }, TIMEOUT)
}
