...
class Split {
    ...
    changeDirection(newDirection) {
        ...
        if (this.direction !== newDirection) {
            ...
            this.offsetSize = newDirection === HORIZONTAL ? "offsetWidth" : "offsetHeight";
            this.offsetPos = newDirection === HORIZONTAL ? "offsetLeft" : "offsetTop";
            this.cursor = newDirection === HORIZONTAL ? 'col-resize' : 'row-resize';
