    ...
    changeDirection(newDirection) {
        ...
        if (this.direction !== newDirection) {
            ...
            for (var i = 0; i < gutters.length; i++) {
                ...
                el = document.querySelectorAll("." + (newDirection == HORIZONTAL ? VERTICAL : HORIZONTAL) + "-" + n);
                el[n].classList.toggle(newDirection + "-" + n);
                el[n].classList.toggle(newDirection == HORIZONTAL ? VERTICAL : HORIZONTAL + "-" + n);
