...
class Split {
    ...
    renderGutter(ghostPos, i, sum) {
        ...
        this.changeDirection(gutter, this.direction);
    ...
    changeDirection(gutter, direction, oldDirection) {
        const localSizes = getLocal(this.direction);
        console.log('localSizes: ', localSizes);
        gutter.className = "split-gutter " + direction;
        gutter.setAttribute("data-direction", direction);
        setLocal(direction, localSizes);
