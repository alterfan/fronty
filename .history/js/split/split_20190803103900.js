...
class Split {
    ...
    renderGutter(ghostPos, i, sum) {
        ...
        if (!overlay) document.body.appendChild(this.overlay);
    ...
    move(e) {
        ...
        removeEventHandler(document.getElementById("resizing-overlay"), "mousemove", this.move);
        removeEventHandler(document, "mouseup", this.done);
        document.getElementById("resizing-overlay").style.display = "none"
        pair.sizes = [];
        is.Move = false;
    }
};
