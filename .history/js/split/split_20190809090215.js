    ...
    changeDirection(newDirection) {
        ...
        for (var i = 0; i < gutters.length + 1; i++) {
            ...
            if (i < gutters.length) {
                ...
                console.log('s: ', s);
                addEventHandler(window, "resize", (e) => {
                    moveGutter(g, this.gutterSize, (newDirection == HORIZONTAL ? "Y" : "X"), this.parent[newDirection == HORIZONTAL ? "offsetWidth" : "offsetHeight"] / 100 * s);
                    moveGutter(g, this.gutterSize, (newDirection == HORIZONTAL ? "X" : "Y"), this.parent[newDirection == HORIZONTAL ? "offsetWidth" : "offsetHeight"] / 100 * s)
                });
