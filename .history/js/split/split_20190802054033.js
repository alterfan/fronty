...
class Split {
    ...
    init() {
        ...
        if (this.splitedNodes !== null) {
            ...
            for (var i = 0; i < n; i++) {
                ...
                this.sizes[i] = сache[i] = !сache[i] ? this.parentSize / n / this.parentSize * 100 : сache[i];
    ...
    move(e) {
        ...
        if (calcA < 0 || calcA > this.parentSize) {
            ...
            this.sizes[this.index - 1] = newSizeA;
            this.sizes[this.index] = newSizeB;
        ...
        for (let i = 0; i < this.splitedNodes.length; i++) {
            ...
            let size = element[this.offsetSize] / this.parentNode[pair.offsetSize] * 100;
            sizes.push(size);
        }
        pair.sizeAxis = null;
        is.Move = false;
        setLocal(this.direction, this.sizes);
        console.log('sizes: ',  this.sizes);
        console.log('this.direction: ', pair.direction);
