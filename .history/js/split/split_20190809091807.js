    ...
    changeDirection(newDirection) {
        ...
        for (var i = 0; i < gutters.length + 1; i++) {
            ...
            if (i < gutters.length) {
                ...
                console.log('s: ', s);
                addEventHandler(window, "resize", (e) => {
                     moveGutter(g, this.gutterSize, axis, this.parent[newDirection == HORIZONTAL ? "offsetWidth" : "offsetHeight"] / 100 * s)
                     console.log('axis, this.parent[newDirection == HORIZONTAL ? "offsetWidth" : "offsetHeight"] / 100 * s: ', axis, this.parent[newDirection == HORIZONTAL ? "offsetWidth" : "offsetHeight"] / 100 * s);
                });
                ...
                moveGutter(g, this.gutterSize, axis, sum);
