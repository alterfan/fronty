...
class Split {
    ...
    start(e) {
        ...
        pair.init = gut;
        this.sizes = [];
        this.direction = gut.getAttribute("data-direction");
        ...
        this.sizes = ls.getStorage(gut.getAttribute("data-direction"));
    ...
    move(e) {
        ...
        if (calcA < 0 || calcA > this.parentSize) {
            ...
            for (let i = 0; i < this.sizes.length; i++) {
                ...
                if (i == this.index - 1) this.sizes[i] = newSizeA
                if (i == this.index) this.sizes[i] = newSizeB
                this.sizes[i] = element
                console.log(' this.sizes: ', this.sizes);
            }
