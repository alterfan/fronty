...
var pair = new class {
    ...
    set init(g) {
        ...
        console.log('this.g.node.getAttribute("data-direction"): ', this.g.node.getAttribute("data-direction"));
        this.b.node = this.g.node.parentNode.querySelector("." + this.g.node.getAttribute("data-direction") + "-" + (this.index));
        console.log(this.a.node.className, this.b.node.className);
...
class Split {
    ...
    move(e) {
        ...
        console.log(this.sizeAxis, pair.a.node.className);
