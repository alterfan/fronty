...
class Split {
    ...
    get elements() {
        console.log('this.Options.parent + " > .split-element": ', this.Options.parent + " > .split-element");
        return document.querySelectorAll(this.Options.parent + " > .split-element");
