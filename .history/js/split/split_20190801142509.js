...
class Split {
    ...
    renderGutter() {
        ...
        for (var i = 0; i < quantity; i++) {
            ...
            gutterGhost.style["transform"] = translate(this.axis, this.parentNode[this.offsetSize] / 100 * gutter[this.offsetPos]);
            console.log('this.splitedNodes[i][this.offsetSize]: ', this.parentNode[this.offsetSize] / 100 * gutter[this.offsetPos]);
