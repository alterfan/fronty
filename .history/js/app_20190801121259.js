$(document).ready(function() {
    ...
    workspace.init()
    workspace.editors["htmlmixed__1"].cm.setValue(ls.getStorage("htmlmixed__1"));
    workspace.editors["css__2"].cm.setValue(ls.getStorage("css__2"));
    workspace.editors["javascript__3"].cm.setValue(ls.getStorage("javascript__3"));
