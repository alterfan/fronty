...
class WorkSpace {
    ...
    render(root) {
        ...
        sh = new Split({
            ...
            sizes: [33, 33, 33],
            direction: this.config.direction == "horizontal" ? "vertical" : "horizontal",
            gutterSize: "12",
            minSizes: "64",
        });
        this.changeDirection("#workspace", this.config.direction);
    ...
    changeDirection(editorsArea, newDirection) {
        ...
        console.log('this.$root.removeClass(this.config.direction): ', this.$root.removeClass(this.config.direction));
        ...
        sv.changeDirection(this.config.direction);
        sh.changeDirection(this.config.direction == "vertical" ? "horizontal" : "vertical");
    }
