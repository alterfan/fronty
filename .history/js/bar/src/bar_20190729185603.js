((mod) => {
    ...
    let close = (cm) => {
        let p = document.querySelectorAll(".bar__group__panel").classList.add("hide")
        document.querySelectorAll(".bar__group__panel").classList.add("hide")
        setTimeout(() => {
