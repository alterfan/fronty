((mod) => {
    ...
    document.addEventListener('mousedown', (event) => {
        if (activeInstance !== null) {
            ...
            if (!e.contains(event.target) || !document.querySelector(".bar__group__panel").contains(event.target)) {
                activeInstance = null;
                close()
            } else {
                return
            }
            console.log('!document.querySelector(".bar__group__panel").contains(event.target): ', !document.querySelector(".bar__group__panel").contains(event.target));
