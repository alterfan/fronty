((mod) => {
    ...
    let addBar = (cm) => {
        ...
        console.log('cm.state.panels: ', cm.state.panels);
    ...
    CodeMirror.on(document, 'mousedown', (event) => {
        if (activeInstance !== null) {
            ...
            console.log('document.querySelector(".bar__group__panel"): ', document.querySelector(".bar__group__panel"));
            if (!e.contains(event.target) && !document.querySelector(".bar")) {
                close();
                activeInstance = null;
            } else {
                return
