((mod) => {
    ...
    const panel = () => {
        let node = dom("div", {
            class: "bar__group__panel hidden"
        });
        separator = dom("span", {
    ...
    let hidePanel = (cm) => {
        let b = cm.state.panels.wrapper.querySelector(".bar");
        b.querySelector(".bar__group__panel").className+=" hidden"
        visiblity = false;
    }
    let showPanel = (cm) => {
        let b = cm.getWrapperElement().parentNode.querySelector(".bar");
        b.querySelector(".bar__group__panel").classList.toggle("hidden")
        console.log('b.querySelector(".bar__group__panel"): ', b.querySelector(".bar__group__panel"));
        visiblity = true;
    }
    CodeMirror.defineOption("toolBar", false, function(cm, val, old) {
        ...
        if (val) {
            ...
            CodeMirror.on(cm.state.panels.wrapper, "mousedown", (cm) => {
