((mod) => {
    ...
    let addBar = (cm) => {
        ...
        icon = dom.new("div", {
            class: "bar__group__item",style:"width:32px;height:32px;"
        });
        icon.style.backgroundImage = "url(assests/icons/" + cm.getOption('mode') + ".png)";
    ...
    document.addEventListener('mousedown', (event) => {
        if (activeInstance !== null) {
            ...
            console.log('!e.contains(event.target): ', !e.contains(event.target));
        }
    });
    /**
     *
