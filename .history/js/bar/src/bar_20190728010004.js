((mod) => {
    ...
    document.addEventListener('mousedown', (event) => {
        if (activeInstance !== null) {
            ...
            if (!e.contains(event.target) || !e.previousElementSibling.contains(event.target)) {
                console.log('!e.previousElementSibling.contains(event.target): ', !e.previousElementSibling.contains(event.target));
                activeInstance = null;
                close()
            } else {
                return
