    ...
    open(el) {
        ...
        if (this.onTop) {
           ...
           // $(".fronty__workspace__editor").addClass("fronty__workspace__editor__splited");
            $(".fronty__workspace__editor").animate({
                "flex-basis": "calc(100% - " + $(".fronty__workspace__sidebar__splited").width() + "px)"
            }, 300);
        }
        setTimeout(function() {
    ...
    close(el) {
        ...
        setTimeout(() => {
            if (this.onTop) {
                ...
                $(".fronty__workspace__editor").animate({
                    "width": "calc(100% - " + $(".fronty__workspace__sidebar__splited").width() + "px)"
                }, 300);
