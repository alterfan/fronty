...
class Sidebar {
    ...
    init(side, parent) {
        ...
        var $parent = $(this.parent),
            $parentFirstChild = $(".fronty__workspace").children(":first-child");
        console.log('$parentFirstChild: ', $parentFirstChild.attr("class"));
        if (side == "left") $sidebar.insertBefore(this.parent + ":first-child");
