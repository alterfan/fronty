$(document).ready(function() {
    ...
    $.each(workspace.config.editors.instances, (indexInArray) => {
        const instance = workspace.config.editors.instances[indexInArray];
        const name = instance[indexInArray].mode + "__" + instance[indexInArray].id;
        workspace.renderEditor(editorsArea, instance);
        workspace.editors[name] = new Editor(document.getElementById(name), name, instance[0].mode);
        workspace.editors[name] = new Editor(document.getElementById(name), name, instance[1].mode);
        workspace.editors[name] = new Editor(document.getElementById(name), name, instance[2].mode);
    });
