$(document).ready(function() {
    ...
    workspace.editors["css__2"] = new Editor(document.getElementById("css__3"), instance[0].mode + "__" + instance[1].id, instance[1].mode);
    workspace.editors["javascript__3"] = new Editor(document.getElementById("javascript__1"), instance[2].mode + "__" + instance[2].id, instance[2].mode);
