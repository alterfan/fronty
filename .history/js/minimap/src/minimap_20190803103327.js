(function(mod) {
    ...
    class MiniMap {
        ...
        init(cm) {
            ...
            this.scroller.style.maxWidth = "calc(100% - " + this.width + "px)";
        ...
        changeOptions(cm) {
            ...
            this.node__code.getWrapperElement().style.fontSize = cm.defaultTextHeight() / this.scale + "px";
            this.node__code.getWrapperElement().style.lineHeight = cm.defaultTextHeight() / this.scale + "px";
            this.node__code.getWrapperElement().style.width = cm.getWrapperElement().offsetWidth / this.scale + "px";
        }
        show(self, callback) {
            if (isVisible == false) {
